...
public class Queries {
    public static String insertIntoTeamsInfoQuery = "INSERT INTO teams_info (teamId,teamName,createdTime,modifiedTime,deleted) VALUES (?,?,?,?,?);";
    public static String insertIntoPlayersInfoQuery = "INSERT INTO players_info (playerId,teamId,playerName,playerRole,inAt,createdTime,modifiedTime,deleted) VALUES (?,?,?,?,?,?,?,?);";
    public static String insertIntoMatchStatsQuery = "INSERT INTO match_stats (matchId, overs,tossWinningTeamId,firstBattingTeamId, secondBattingTeamId,winnerTeamId,createdTime,modifiedTime,deleted) VALUES (?,?,?,?,?,?,?,?,?);";
    public static String insertIntoPerBallStatsQuery = "INSERT INTO per_ball_stats (matchId,battingTeamId,overNumber,ballNumber,batterId,bowlerId,resultOnThatBall,createdTime,modifiedTime,deleted) VALUES (?,?,?,?,?,?,?,?,?,?);";
